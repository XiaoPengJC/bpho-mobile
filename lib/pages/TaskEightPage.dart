...
class TaskEightPage extends StatefulWidget {
	const TaskEightPage({super.key, required this.title});

	final String title;
	final description = 'Use your orbital models to plot the 3D orbits of the other bodies in the solar system, with a chosen object (e.g. Earth) at a fixed position at the origin of a Cartesian coordinate system. i.e. choose a coordinate system where your chosen object is at (0,0,0).';

	@override
	State<TaskEightPage> createState() => _TaskEightPageState();
}

class _TaskEightPageState extends State<TaskEightPage> {
  ...
  var items = ['Mercury', 'Venus', 'Earth', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto'];
	...
	String generateUrl() {
		String url = 'http://18.134.43.174/imaginary_orbit?is3d=true';
