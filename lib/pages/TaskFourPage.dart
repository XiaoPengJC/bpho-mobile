...
class TaskFourPage extends StatefulWidget {
	const TaskFourPage({super.key, required this.title});

	final String title;
	final String description = 'Create a 3D animation of the orbits of the planets.';
							...
							children: <Widget>[
								MainButton(
									...
									onPressed: () => Navigator.push(
										context,
										MaterialPageRoute(builder: (context) => const TaskFourInnerPage(title: 'Inner Planets')),
									),
									isWhite: true,
								),
								MainButton(
									...
									onPressed: () => Navigator.push(
										context,
										MaterialPageRoute(builder: (context) => const TaskFourOuterPage(title: 'Outer Planets')),
									), 
									isWhite: true,
								)
							],
...
class TaskFourInnerPage extends StatefulWidget {
	const TaskFourInnerPage({super.key, required this.title});

	final String title;
	final description = 'Create a 3D animation of the orbits of the inner planets.';

	@override
	State<TaskFourInnerPage> createState() => _TaskFourInnerPageState();
}

class _TaskFourInnerPageState extends State<TaskFourInnerPage> {
	...
	String generateUrl() {
		String url = 'http://18.134.43.174/orbit_animation?is3d=true';
...
class TaskFourOuterPage extends StatefulWidget {
	const TaskFourOuterPage({super.key, required this.title});

	final String title;
	final description = 'Create a 3D animation of the orbits of the outer planets plus Pluto.';

	@override
	State<TaskFourOuterPage> createState() => _TaskFourOuterPageState();
}

class _TaskFourOuterPageState extends State<TaskFourOuterPage> {
